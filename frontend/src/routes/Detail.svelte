		...
		<div class="card-body">
			...
			<div class="d-flex justify-content-end">
				{#if question.modify_date}
					<div class="badge gb-light text-dark p-2 text-start mx-3">
						<div class="mb-2">수정 시각</div>
						<div>
							{moment(question.modify_date).format("YYYY년 MM월 DD일 a hh:mm")}
						</div>
					</div>
				{/if}
			...
			<div class="card-body">
				...
				<div class="d-flex justify-content-end">
					{#if answer.modify_date}
						<div class="badge bg-light text-dart p-2 text-start mx-3">
							<div class="mb-2">수정 시각</div>
							<div>
								{moment(answer.modify_date).format("YYYY년 MM월 DD일 a hh:mm")}
							</div>
						</div>
					{/if}
					<div class="badge bg-light text-dark p-2 text-start">
